...
/**
 * 对于数组实例来说，其类型是由JVM在运行期动态生成的，表示为 [Lzy.jvm.classloader.MyParent4 这种形式。
...
//================
        ...
        //运行结果 class [Lzy.jvm.classloader.MyParent4;和class java.lang.Object，JVM在运行期创建出[Lzy.jvm.classloader.MyParent4这个类型
