package com.test.bussiness.service;

import com.test.bussiness.feign.OrderFeignClient;
import com.test.bussiness.feign.StorageFeignClient;
...
public class BusinessService {
    ...
    public void initData() {
        jdbcTemplate.update("truncate undo_log");
    ...
    public void purchase(String userId, String commodityCode, int orderCount) {
        ...
        boolean orderResult = orderFeignClient.create(userId, commodityCode, orderCount);
